...
export default function DetailPanel({ project, onClose }: Props) {
  const images =
    project.images && project.images.length > 0 ? project.images : ["/images/placeholder-cyber.svg"]
  ...
  return (
    <div className="detail-backdrop" onClick={onClose}>
      <div className="detail-card" style={style} onClick={(e) => e.stopPropagation()}>
        <div className="detail-header">
          <div>
            ...
            <div className="detail-meta">
              ...
              {project.stack && <span className="detail-chip">{project.stack}</span>}
            </div>
          </div>
        ...
        <div className="detail-grid">
          <div className="detail-media">
            <div className="detail-hero">
              <img className="detail-image" src={hero} alt={`${project.name} preview`} />
              {canNavigate && (
                <>
                  <button
